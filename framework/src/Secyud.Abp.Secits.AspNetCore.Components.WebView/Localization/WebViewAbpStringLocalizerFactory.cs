...
public class WebViewAbpStringLocalizerFactory(
    ...
    : IAbpStringLocalizerFactory, IStringLocalizerFactory
{
    protected internal AbpLocalizationOptions AbpLocalizationOptions { get; } = abpLocalizationOptions.Value;
    protected ResourceManagerStringLocalizerFactory InnerFactory { get; } = innerFactory;
    protected IServiceProvider ServiceProvider { get; } = serviceProvider;
    protected IExternalLocalizationStore ExternalLocalizationStore { get; } = externalLocalizationStore;
    protected ConcurrentDictionary<string, StringLocalizerCacheItem> LocalizerCache { get; } = new();
    ...
    private StringLocalizerCacheItem CreateStringLocalizerCacheItem(LocalizationResourceBase resource)
    {
        ...
        return new StringLocalizerCacheItem(
            new WebViewAbpDictionaryBasedStringLocalizer(
                resource,
                resource
                    .BaseResourceNames
    ...
    {
        services.Replace(ServiceDescriptor.Singleton<IStringLocalizerFactory, WebViewAbpStringLocalizerFactory>());
        services.AddSingleton<ResourceManagerStringLocalizerFactory>();
    }

    protected class StringLocalizerCacheItem
    {
        public WebViewAbpDictionaryBasedStringLocalizer Localizer { get; }

        public StringLocalizerCacheItem(WebViewAbpDictionaryBasedStringLocalizer localizer)
        {
            Localizer = localizer;
        }
    }
