...
public class EfCoreIdentityRoleRepository(IDbContextProvider<IIdentitiesDbContext> dbContextProvider)
    : EfCoreRepository<IIdentitiesDbContext, IdentityRole, Guid>(dbContextProvider), IIdentityRoleRepository
{
