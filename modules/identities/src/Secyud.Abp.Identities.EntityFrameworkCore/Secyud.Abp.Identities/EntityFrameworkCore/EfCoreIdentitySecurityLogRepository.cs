...
public class EfCoreIdentitySecurityLogRepository(IDbContextProvider<IIdentitiesDbContext> dbContextProvider)
    : EfCoreRepository<IIdentitiesDbContext, IdentitySecurityLog, Guid>(dbContextProvider), IIdentitySecurityLogRepository
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var query = await GetListQueryAsync(
            startTime, endTime, applicationName, identity, action, userId,
            userName, clientId, correlationId, clientIpAddress, cancellationToken
        );
