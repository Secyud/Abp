...
public class EfCoreIdentitySessionRepository(IDbContextProvider<IIdentitiesDbContext> dbContextProvider)
    : EfCoreRepository<IIdentitiesDbContext, IdentitySession, Guid>(dbContextProvider), IIdentitySessionRepository
{
