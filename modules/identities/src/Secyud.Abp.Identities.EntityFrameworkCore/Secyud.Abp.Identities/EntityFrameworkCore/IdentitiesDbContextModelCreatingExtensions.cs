...
public static class IdentitiesDbContextModelCreatingExtensions
{
    public static void ConfigureIdentities(this ModelBuilder builder)
    {
        Check.NotNull(builder, nameof(builder));

        builder.Entity<IdentityUser>(b =>
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "Users", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "UserClaims", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "UserRoles", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "UserLogins", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "UserTokens", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "Roles", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "RoleClaims", AbpIdentitiesDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "ClaimTypes", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "SecurityLogs", AbpIdentitiesDbProperties.DbSchema);
        ...
        if (builder.IsHostDatabase())
        {
            ...
            {
                b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "LinkUsers", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "UserDelegations", AbpIdentitiesDbProperties.DbSchema);
        ...
        {
            b.ToTable(AbpIdentitiesDbProperties.DbTablePrefix + "Sessions", AbpIdentitiesDbProperties.DbSchema);
        ...
        builder.TryConfigureObjectExtensions<IdentitiesDbContext>();
    }
}