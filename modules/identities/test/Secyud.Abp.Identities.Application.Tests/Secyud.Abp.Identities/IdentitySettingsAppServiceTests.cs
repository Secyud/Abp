...
public class IdentitySettingsAppServiceTests : AbpIdentityApplicationTestBase
{
    ...
    public IdentitySettingsAppServiceTests()
    {
    ...
    public async Task GetAsync()
    {
        ...
        identitySettingsDto.User!.IsEmailUpdateEnabled =
            await _settingProvider.GetAsync(IdentitiesSettingNames.User.IsEmailUpdateEnabled, true);
        identitySettingsDto.User.IsUserNameUpdateEnabled =
            await _settingProvider.GetAsync(IdentitiesSettingNames.User.IsUserNameUpdateEnabled, true);
    }
    ...
    public async Task UpdateAsync()
    {
        var isEmailUpdateEnabled =
            (await _settingProvider.GetOrNullAsync(IdentitiesSettingNames.User.IsEmailUpdateEnabled))!.Equals("true",
                StringComparison.InvariantCultureIgnoreCase);

        var isUserNameUpdateEnabled =
            (await _settingProvider.GetOrNullAsync(IdentitiesSettingNames.User.IsUserNameUpdateEnabled))!.Equals(
                "true",
                StringComparison.InvariantCultureIgnoreCase);
