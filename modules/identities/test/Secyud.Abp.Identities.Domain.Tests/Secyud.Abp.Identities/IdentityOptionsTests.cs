...
public class IdentityOptionsTests : AbpIdentityDomainTestBase
{
    private ISettingProvider _settingProvider = null!;
    ...
    public async Task Should_Get_Options_From_Custom_Settings_If_Available()
    {
        ...
        _settingProvider.GetOrNullAsync(IdentitiesSettingNames.Password.RequiredLength)!.Returns(Task.FromResult("42"));
