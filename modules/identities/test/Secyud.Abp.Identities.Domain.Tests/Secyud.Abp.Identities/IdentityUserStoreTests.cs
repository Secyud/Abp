...
public class IdentityUserStoreTests : AbpIdentityDomainTestBase
{
    ...
    [Fact]
    public void IdentityUserStore_Should_Be_Replaced_By_IdentitiesUserStore()
    {
        GetRequiredService<IdentityUserStore>().GetType().ShouldBe(typeof(IdentitiesUserStore));
        GetRequiredService<IUserStore<IdentityUser>>().GetType().ShouldBe(typeof(IdentitiesUserStore));
    }
