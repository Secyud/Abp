...
public class AppAbpStringLocalizerFactory(
    ...
    : IAbpStringLocalizerFactory, IStringLocalizerFactory
{
    ...
    private StringLocalizerCacheItem CreateStringLocalizerCacheItem(LocalizationResourceBase resource)
    {
        ...
        return new StringLocalizerCacheItem(
            new AppAbpDictionaryBasedStringLocalizer(
                resource,
                resource
                    .BaseResourceNames
    ...
    {
        services.Replace(ServiceDescriptor.Singleton<IStringLocalizerFactory, AppAbpStringLocalizerFactory>());
        services.AddSingleton<ResourceManagerStringLocalizerFactory>();
    }

    protected class StringLocalizerCacheItem
    {
        public AppAbpDictionaryBasedStringLocalizer Localizer { get; }

        public StringLocalizerCacheItem(AppAbpDictionaryBasedStringLocalizer localizer)
        {
            Localizer = localizer;
        }
    }
