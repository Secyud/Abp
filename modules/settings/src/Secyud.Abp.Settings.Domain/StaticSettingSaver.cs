...
public class StaticSettingSaver(
    ...
    : IStaticSettingSaver, ITransientDependency
{
    protected IStaticSettingDefinitionStore StaticStore { get; } = staticStore;
    protected ISettingDefinitionRecordRepository SettingRepository { get; } = settingRepository;
    protected ISettingDefinitionSerializer SettingSerializer { get; } = settingSerializer;
    ...
    protected AbpSettingOptions SettingOptions { get; } = settingOptions.Value;
