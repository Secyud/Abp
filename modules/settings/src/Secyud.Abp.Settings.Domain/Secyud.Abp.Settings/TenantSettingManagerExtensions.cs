...
{
    public static Task<string?> GetOrNullForTenantAsync(this ISettingManager settingManager, string name, Guid tenantId, bool fallback = true)
    {
        return settingManager.GetOrNullAsync(name, TenantSettingValueProvider.ProviderName, tenantId.ToString(), fallback);
    }

    public static Task<string?> GetOrNullForCurrentTenantAsync(this ISettingManager settingManager, string name, bool fallback = true)
    {
    ...
    public static Task SetForTenantAsync(this ISettingManager settingManager, Guid tenantId, string name, string? value, bool forceToSet = false)
    {
        return settingManager.SetAsync(name, value, TenantSettingValueProvider.ProviderName, tenantId.ToString(), forceToSet);
    }

    public static Task SetForCurrentTenantAsync(this ISettingManager settingManager, string name, string? value, bool forceToSet = false)
    {
        return settingManager.SetAsync(name, value, TenantSettingValueProvider.ProviderName, null, forceToSet);
    }

    public static Task SetForTenantOrGlobalAsync(this ISettingManager settingManager, Guid? tenantId, string name, string? value, bool forceToSet = false)
    {
