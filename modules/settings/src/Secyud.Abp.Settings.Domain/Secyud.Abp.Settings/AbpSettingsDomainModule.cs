...
public class AbpSettingsDomainModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            Configure<SettingsOptions>(options => { options.SaveStaticSettingsToDatabase = false; });
        }
    }
    ...
    private void InitializeDynamicSettings(ApplicationInitializationContext context)
    {
        ...
        if (options is { SaveStaticSettingsToDatabase: false, IsDynamicSettingStoreEnabled: false })
        {
            return;
        }
    ...
    private static async Task SaveStaticSettingsToDatabaseAsync(
        SettingsOptions options, IServiceScope scope,
            ...
            .ExecuteAsync(async _ =>
            {
                ...
                catch (Exception ex)
                {
                    ...
                    scope.ServiceProvider
                        .GetService<ILogger<AbpSettingsDomainModule>>()?
                        .LogException(ex);
