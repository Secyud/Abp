...
public class FeatureDefinitionSerializerTests : FeaturesDomainTestBase
{
    private readonly IFeatureDefinitionSerializer _serializer;

    public FeatureDefinitionSerializerTests()
    {
    ...
    public async Task Serialize_Complex_Feature_Definition()
    {
        ...
        var feature1 = group1.AddFeature(
                "Feature1",
                "default",
                new LocalizableString(typeof(AbpFeaturesResource), "Feature1"),
                new LocalizableString(typeof(AbpFeaturesResource), "Feature1"),
        ...
        featureRecord.DisplayName.ShouldBe("L:AbpFeatures,Feature1");
