...
public class EfCoreFeatureValueRepository(IDbContextProvider<IFeaturesDbContext> dbContextProvider)
    : EfCoreRepository<IFeaturesDbContext, FeatureValue, Guid>(dbContextProvider), IFeatureValueRepository
{
