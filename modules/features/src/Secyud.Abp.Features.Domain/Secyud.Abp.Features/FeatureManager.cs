...
public class FeatureManager(
    ...
    : IFeatureManager, ISingletonDependency
{
    private readonly Lazy<List<IFeaturesProvider>> _featuresProviders = new(() =>
    {
        return options.Value
            .Providers
            .Select(c => (IFeaturesProvider)
    ...
    protected List<IFeaturesProvider> FeaturesProviders => _featuresProviders.Value;
        ...
        string? providerKey, bool fallback = true)
    {
        ...
        var providers = Enumerable.Reverse(FeaturesProviders).SkipWhile(c => c.Name != providerName);
