...
public class StaticFeatureSaver(
    ...
    IOptions<AbpFeatureOptions> featuresOptions,
    ICancellationTokenProvider cancellationTokenProvider,
    IUnitOfWorkManager unitOfWorkManager)
    : IStaticFeatureSaver, ITransientDependency
{
    protected IStaticFeatureDefinitionStore StaticStore { get; } = staticStore;
    ...
    protected IFeatureDefinitionSerializer FeatureSerializer { get; } = featureSerializer;
    ...
    protected AbpFeatureOptions FeatureOptions { get; } = featuresOptions.Value;
