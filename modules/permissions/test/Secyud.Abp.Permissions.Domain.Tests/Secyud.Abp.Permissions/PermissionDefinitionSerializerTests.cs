...
public class PermissionDefinitionSerializerTests : PermissionTestBase
{
    ...
    public async Task Serialize_Complex_Permission_Definition()
    {
        ...
        var permission1 = group1.AddPermission(
                "Permission1",
                new LocalizableString(typeof(AbpPermissionsResource), "Permission1"),
        ...
        permissionRecord.DisplayName.ShouldBe("L:AbpPermissions,Permission1");
